...
<div class="main-wrapper">
    ...
    <!-- Banner -->
    <section class="banner-section-course-python">
        <div class="container">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="blog-view">
                                                <div class="blog blog-single-post">
                                                    <div class="blog-image">
                                                        <a href="javascript:void(0);"><img alt="" src="assets/img/python-coding.jpg" class="img-fluid"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-7 col-sm-12 col-lg-6">
                                            <div class="blog-view">
                                                <div class="blog blog-single-post">
                                                    <h3 class="blog-title">Programming and Coding With python</h3>
                                                    <div class="blog-info clearfix">
                                                        <div class="post-left">
                                                            <ul>
                                                                ...
                                                                <li> <i class="fa fa-code"></i> Path: Coding, Game Dev, Computational Thinking</li>
                                                                <li><i class="fa fa-tags"></i>Python</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="blog-content">
                                                        <p class="lead">Coding skills are among the most in-demand in today’s job market.
                                                            Get your real-world experience with this introduction to computational thinking!
                                                            Once you have the basics down, go further to see how your coding knowledge applies to algorithms, arcade game design, and more.
                                                            You’ll start with logic games and Python—the fastest-growing programming language available—then move into object-oriented concepts.
                                                            As your understanding of coding deepens, explore creating more advanced programs with graphics.
                                                            With these fundamentals, you'll be equipped to tackle whatever coding challenges you face next!</p>
                                            ...
                                            <div class="blog blog-single-post">
                                                <div class="blog-content">
                                                    ...
                                                    <ol class="lead">
                                                        ...
                                                        <li>-Prepare for more advanced coding content</li>
                                                        <li>-Gain computational thinking skills</li>
                                                    </ol>
