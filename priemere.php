...
<div class="main-wrapper">
    ...
    <!-- Banner -->
    <section class="banner-section-course-premiere">
        <div class="container">
                                            ...
                                            <div class="blog-view">
                                                <div class="blog blog-single-post">
                                                    <div class="blog-image">
                                                        <a href="javascript:void(0);"><img alt="" src="assets/img/adobe-premiere-course.jpg" class="img-fluid"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="blog-info clearfix">
                                                        <div class="post-left">
                                                            <ul>
                                                                ...
                                                                <li> <i class="fa fa-code"></i> Path: Video Editing, Video Manipulation, Effects.</li>
                                                                <li><i class="fa fa-tags"></i>Adobe Premiere Pro.</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="blog-content">
                                                        <p class="lead">Creators flock to YouTube to show off their stories and vision through videos and commentary.
                                                            But creating is more than just pressing the upload button.
                                                            You'll need skills in some of the most powerful industry-wide programs in the Adobe Suite, from Photoshop and Animate to Premiere and beyond.
                                                            Next time you have an idea, you’ll have the ability to follow through and bring it to life.
                                                            Though the software comes with a brilliant introductory guide, designed to take you through the basics, you may still want to learn more.
                                                             </p>
                                        ...
                                        <div class="blog-view">
                                            <div class="blog blog-single-post">
                                                <div class="blog-content">
                                                    ...
                                                    <ol class="lead">
                                                        <li>-Edit video and audio tracks</li>
                                                        <li>-Create special effects and animations</li>
                                                        <li>-Use animation and design tools</li>
                                                        <li>-Practice character design and 2D animation/creative techniques</li>
                                                        <li>-Make art to upload to social media</li>
                                                        <li>-Translate visual inspiration to an effective digital portfolio</li>
                                                    </ol>
