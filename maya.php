        ...
        <div class="container">
            <div class="banner-content text-center">
                <div class="banner-heading">
                    <h2>Autodesk Maya Tutoring</h2>
                    <p>3D Modeling with Autodesk Maya Tutoring</p>
                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="blog-view">
                                                <div class="blog blog-single-post">
                                                    <div class="blog-image">
                                                        <a href="javascript:void(0);"><img alt="" src="assets/img/maya-coding.jpg" class="img-fluid"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-7 col-sm-12 col-lg-6">
                                            <div class="blog-view">
                                                <div class="blog blog-single-post">
                                                    <h3 class="blog-title">3D Modeling with Autodesk Maya Tutoring</h3>
                                                    <div class="blog-info clearfix">
                                                        <div class="post-left">
                                                            <ul>
                                                                ...
                                                                <li> <i class="fa fa-code"></i> Path: 3D Modelling, Creativity, Art </li>
                                                                <li><i class="fa fa-tags"></i>Maya</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="blog-content">
                                                        <p class="lead">From cute characters and rocket engine parts to realistic environments, 3D-modeled objects are changing the world and being used in countless industries.
                                                            In this course, you'll use Autodesk Maya to design and create intricate 3D models.
                                                            Making your characters, stories, or even simple animated shorts jump off the screen is the name of the game.
                                                            Record sounds, draw characters and backgrounds, and flex your creative muscles!
                                                            Maya has a huge advantage over 3ds Max when it comes to modeling nurbs as it uses different approach and is more user friendly.
                                                            Many 3D animators consider Maya a better software for creating 3D animation as it has greater capacity for simulating realistic animations and effects.</p>

                                                        <h4>Online Course Requirements:</h4>
                                                        <ol>
                                                            <li>-Mac, Windows PC, or Chromebook only</li>
                                                            <li>-Autodesk maya Software</li>
                                                            <li>-WebCam</li>
                                            ...
                                            <div class="blog blog-single-post">
                                                <div class="blog-content">
                                                    ...
                                                    <ol class="lead">
                                                        ...
                                                        <li>-Develop environment and hard surface modeling techniques</li>
