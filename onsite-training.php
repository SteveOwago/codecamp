        ...
        <div class="container">
            <div class="banner-content text-center">
                <div class="banner-heading">
                    <h2>VIRTUAL TECHCAMP AT INNOVATION ACADEMY</h2>
                    <p>Join Us in Our Bootcamps to Learn New Skills.</p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-10 offset-1">
                    <div class="card-default">
                        <div class="card-title"><h2>Virtual Tech Bootcamps</h2></div>
                        <div class="card-body">
                            <p>Camp is in session! Join over 1,000 students who are building in-demand skills, collaborating with friends, gaining confidence, and having fun. For ages 7-18. Space is limited and courses are filling fast!</p>
                            <p>We have a structured, weeklong sessions available now at different times(5 consecutive days, Monday-Friday)</p>
                            <p>Get the hottest curriculum in Python, Java, Minecraft, Roblox, Unity, Adobe, 3D modeling, and more</p>
                            <p>Average of 10 students per instructor, blending personalized learning and time to socialize with new friends</p>
							<p>A balanced schedule including 2 hours of live instruction and peer collaboration + 2 hours of self-paced project development per day</p>
                            
                            <h3>Experience iEARN Innovation Academy, anywhere</h3>
                            <p>Prefer an at-home experience? Our online programs bring the collaborative spirit of camp right to your personal computer.</p>
                            <p>Or, with our on-campus summer programs, you'll get inspired by iconic architecture, learn in our next-gen labs, and experience collegiate life in the dining halls.</p>
                            <p>We’re the only summer tech program that’s trusted by over 150 of the top universities on the planet.</p>
                        </div>
                    </div>
                </div>
                <div class="section-btn m-auto">
                    <p class="lead">To learn More About iEARN KENYA click the link in the button below</p>
                    <a href="https://iearnkenya.org/" target="_blank"><button class="btn btn-course">ABOUT iEARN KENYA<i class="fas fa-caret-right right-nav-white"></i></button></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="popular-course-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="section-btn m-auto">
                    <a href="courses.php"><button class="btn btn-course">View all Courses <i class="fas fa-caret-right right-nav-white"></i></button></a>
                </div>
            </div>
        </div>
    </section>
