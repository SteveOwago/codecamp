							...
							<div class="col-sm-8 offset-2">
								<div class="card">
									...
									<div class="card-body">
										...
										<p><strong><i class="fas fa-list"></i>  Reading Material(s): </strong><a class="text-primary" href="<?php echo 'includes/uploads/sessions/'.$sessionfile; ?>" target="_blank"><?php echo $sessionfile; ?></a></p>
