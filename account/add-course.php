								...
								<div style="padding: 3%;">
									<form method="post" action="includes/functions.php">
										<div class="form-group">
											...
											<input type="text" name="name" class="form-control" id="exampleFormControlInput1" placeholder="Block-Based Coding with Scratch" required>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="datetime-local" name="date" class="form-control" id="exampleFormControlInput1" required>
										</div>
										
										<div class="form-group">
											<label for="exampleFormControlInput1">Price</label>
											<input type="number" name="price" class="form-control" id="exampleFormControlInput1" placeholder="20000" required>
										</div>
										<div class="form-group">
											<input type="submit" name="add-course" value="Submit" class="form-control btn btn-success">
										</div>
									</form>
								</div>
							</div>
