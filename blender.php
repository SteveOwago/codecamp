...
<div class="main-wrapper">
    ...
    <!-- Banner -->
    <section class="banner-section-course-blender">
        <div class="container">
            <div class="banner-content text-center">
                <div class="banner-heading">
                    <h2>3D Modeling With Blender</h2>
                    <p>Learn #D and Creative Design With Blender</p>
                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="blog-view">
                                                <div class="blog blog-single-post">
                                                    <div class="blog-image">
                                                        <a href="javascript:void(0);"><img alt="" src="assets/img/blender-design.jpg" class="img-fluid"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-7 col-sm-12 col-lg-6">
                                            <div class="blog-view">
                                                <div class="blog blog-single-post">
                                                    <h3 class="blog-title">Creative Art and Design With Blender</h3>
                                                    <div class="blog-info clearfix">
                                                        <div class="post-left">
                                                            <ul>
                                                                ...
                                                                <li><i class="fa fa-tags"></i>blender</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="blog-content">
                                                        <p class="lead">Blender is a free and open source software, making it popular among hobbyists and indie game developers alike.
                                                            This software is a complete package and not only has 3D modeling tools but animation, simulation, and rendering capabilities as well.
                                                            Blender features a node editor which allows for advance manipulation of videos and motion tracker.
                                                            Game engine. Over the years, blender game engine has improved, blender can be used alongside other software's like unity to build really cool games.
                                                            You can build your 3d models directly on blender and import to Unity.</p>
                                        ...
                                        <div class="blog-view">
                                            <div class="blog blog-single-post">
                                                <div class="blog-content">
                                                    ...
                                                    <ol class="lead">
                                                        <li>-Use polygon modeling tools</li>
                                                        <li>-Basic concepts in 3D modelling</li>
                                                        <li>-Develop environment and hard surface modeling techniques</li>
                                                        <li>-Adding Lighting and Material</li>
